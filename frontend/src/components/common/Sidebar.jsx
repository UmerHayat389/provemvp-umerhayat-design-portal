...
import { X, Home, Calendar, UserCheck, Briefcase } from 'lucide-react'; // ✅ added Briefcase
...
const Sidebar = ({ user, sidebarOpen, setSidebarOpen }) => {
  ...
  const adminLinks = [
    ...
    { to: '/admin/projects',        label: 'Assign Projects',  icon: <Briefcase size={20} /> }, // ✅ NEW
    { to: '/admin/manageemployees', label: 'Manage Employees', icon: <Calendar size={20} /> },
  ];
  ...
  const employeeLinks = [
    ...
    { to: '/employee/projects',   label: 'My Projects',   icon: <Briefcase size={20} /> }, // ✅ NEW
  ];
